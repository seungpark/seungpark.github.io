        ...
        <main id="main">
          ...
          <section id="programming-skills">
            <div className="container">
              ...
              <div className="flex-container">
                <div className="grid-el"><img alt="node.js" src="images/thumbnails/node.png" /><p>NODE</p></div>
                <div className="grid-el"><img alt="typescript" src="images/thumbnails/typescript.png" /><p>TYPESCRIPT</p></div>
                <div className="grid-el"><img alt="javascript" src="images/thumbnails/javascript.png" /><p>JAVASCRIPT</p></div>
                <div className="grid-el"><img alt="postgresql" src="images/thumbnails/postgresql.png" /><p>SQL</p></div>
                <div className="grid-el"><img alt="react" src="images/thumbnails/react.jpg" /><p>REACT</p></div>
                <div className="grid-el"><img alt="angular" src="images/thumbnails/angular.png" /><p>ANGULAR</p></div>
                <div className="grid-el"><img alt="git" src="images/thumbnails/git.png" /><p>GIT</p></div>
                <div className="grid-el"><img alt="aws" src="images/thumbnails/aws.png" /><p>AWS</p></div>
                <div className="grid-el"><img alt="python" src="images/thumbnails/python.png" /><p>PYTHON</p></div>
                <div className="grid-el"><img alt="mongodb" src="images/thumbnails/mongodb.png" /><p>MONGODB</p></div>
                <div className="grid-el"><img alt="ruby" src="images/thumbnails/ruby.png" /><p>RUBY</p></div>
                <div className="grid-el"><img alt="html5" src="images/thumbnails/HTML5.png" /><p>HTML5</p></div>
                <div className="grid-el"><img alt="css" src="images/thumbnails/css.png" /><p>CSS</p></div>
              </div>
            </div>
          </section>
          ...
          <section id="recent-projects">
            <div className="container">
              ...
              <div className="features">
                <article>
                  <a href="https://www.mongodb.com/docs/manual/" aria-label="MongoDB documentation" className="image"><img src="images/project-samples/mongodb-docs.png" alt="" /></a>
                  <div className="inner">
                ...
                <article>
                  <a href="https://www.mongodb.com/docs/api/" aria-label="MongoDB API documentation" className="image"><img src="images/project-samples/mongodb-bump.png" alt="" /></a>
                  <div className="inner">
                ...
                <article>
                  <a href="https://app.gro-intelligence.com/login" aria-label="Gro Web App" className="image"><img src="images/project-samples/gro-app.png" alt="" /></a>
                  <div className="inner">
                ...
                <article>
                  <a href="https://pypi.org/project/groclient" aria-label="Gro API Client" className="image"><img src="images/project-samples/gro-logo.png" alt="" /></a>
                  <div className="inner">
          ...
          <section id="capstone-projects">
            <div className="container">
              ...
              <div className="features">
                <article>
                  <a href="http://github.com/seungpark/chess-on-ruby" aria-label="Chess on Ruby" className="image"><img src="images/project-samples/chess.png" alt="" /></a>
                  <div className="inner">
                    <h4>Chess on Ruby</h4>
                ...
                <article>
                  <a href="http://seungpark.com/chogrow" aria-label="Snake game with a League of Legends Twist" className="image"><video src="images/project-samples/chogrow.mp4" loop playsInline /></a>
                  <div className="inner">
                    <h4>ChoGrow</h4>
                    <p>
